...
export const categoryBanners: BannerData[] = [
  ...
  },
  {
    ...
    type: BannerType.CATEGORY,
    image: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80',
...
export const promotionalBanners: BannerData[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1576224120508-f04b0bec5919?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80',
  ...
  },
  {
    ...
    type: BannerType.PROMOTION,
    image: 'https://images.unsplash.com/photo-1607083206968-13611e3d76db?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1115&q=80',
    ctaText: 'Learn More',
    linkTo: '/referral',
...
export const getBannersByType = (type: BannerType): BannerData[] => {
  return [...featuredBanners, ...categoryBanners, ...promotionalBanners]
